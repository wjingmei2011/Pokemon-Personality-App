        ...
        messages: [
            {
                ...
                content: `Please generate a personalized paragraph to describe a Pokémon match for a user. Make the description sound personalized, as if it matches the personality and preference of the user, but 
                    ...
                    Start the last sentence with 4 spaces away from the previous one, and generate a simple but specific fortune cookie message about the upcoming year of 2025 for the user. Here is an example (but no need to use it as a template): Wynaut is the perfect Pokémon for you! As a pure Psychic-type, Wynaut embodies curiosity, positivity, and an infectious sense of playfulness—qualities often seen in those born in summer, who are natural leaders with a sunny disposition. With its abilities, Shadow Tag and Telepathy, Wynaut is always aware of its surroundings, making it a clever and intuitive companion. Your favorite color, pink, highlights Wynaut's cheerful and lighthearted nature, as it reflects a sense of warmth, kindness, and compassion. Wynaut reminds you to embrace your inner joy, take on challenges with a smile, and connect deeply with those around you. Together, you and Wynaut are a dynamic force of optimism and empathy—spreading positivity wherever you go, just like a bright pink summer bloom in August!   Your Pokémon's secret message for you : "2025 is destined to be your year of growth and unexpected joys – embrace the surprises and adventures coming your way!"`
            }
        ],
